...
#Created 6-19-2013  https://github.com/dasu/powershell-scripts/blob/master/Word%20unlocker.ps1
#Modified 12-28-2021
...
# SET YOUR PATH ON THE NEXT LINE
foreach ($FILE in Get-ChildItem "C:\Users\YOURUSER\Documents\" -Include *.doc)
